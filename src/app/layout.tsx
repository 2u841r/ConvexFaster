...
export const metadata: Metadata = {
  title: {
    template: "%s | ConvexFaster",
    default: "ConvexFaster",
  },
  description: "A performant site built with Convex + Next.js",
};
        ...
        <ConvexProvider>
          ...
          <footer className="fixed bottom-0 flex h-12 w-screen flex-col items-center justify-between space-y-2 border-t border-gray-400 bg-background px-4 font-sans text-[11px] sm:h-6 sm:flex-row sm:space-y-0">
            <div className="flex flex-wrap justify-center space-x-2 pt-2 sm:justify-start">
              <span className="mb-2 hover:bg-accent2 hover:underline">
                <Link href="https://github.com/2u841r" target="_blank">
                  {" "}
                  Developed by Zubair Ibn Zamir{" "}
                </Link>
              </span>
            </div>
            <div className="text-center sm:text-right">
              ...
              <Link
                href="https://github.com/2u841r/ConvexFaster"
